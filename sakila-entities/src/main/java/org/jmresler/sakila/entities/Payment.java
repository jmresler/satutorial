 ...
 */
@Entity
@Table(name = "payment", catalog = "sakila", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Payment implements Serializable {
    ...
    public Payment(Long paymentId, BigDecimal amount, Date paymentDate) {
        this.paymentId = paymentId;
        this.amount = amount;
    ...
    public String toString() {
        return "org.jmresler.sakila.entities.Payment[ paymentId=" + paymentId + " ]";
    }
